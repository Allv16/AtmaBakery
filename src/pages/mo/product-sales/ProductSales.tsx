...
import {
  getIngredientsUsage,
  getProductSales,
} from "../../../lib/repository/ReportRepository";
            ...
            <>
              ...
              <div className="overflow-x-auto rounded-md">
                <table className="table table-zebra">
                  ...
                  <tfoot>
                  <tr>
                    <td colSpan={4} className="text-right text-black text-sm">Total:</td>
                    <td className="text-black text-bas text-sm">
                      {currencyConverter(data.reduce((acc, item) => acc + item.total, 0))}
                    </td>
                  </tr>
                </tfoot>
                </table>
