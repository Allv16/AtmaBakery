                ...
                <form className="flex flex-col gap-6" onSubmit={(e) => {
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-6">
                        ...
                        <input type="date" className="input w-full max-w-md" name="tanggal_pengeluaran"
                            value={selectedDate} onChange={handleDateChange} required />
                    </div>
                    ...
                    <div className="flex justify-end gap-3 mt-10">
                        ...
                        <button className="btn btn-primary" type="submit">Add Other Expense</button>
                    </div>
                </form>
                <dialog id="edit_modal" className="modal" hidden>
                    <div className="modal-box">
                        <h3 className="font-bold text-lg">Confirmation</h3>
                        <p className="py-4">Are you sure you want to add this other expense?</p>
