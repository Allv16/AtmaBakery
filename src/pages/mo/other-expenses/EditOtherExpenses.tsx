...
import { editOtherExpenses, getOtherExpensesById } from "../../../lib/repository/OtherExpensesRepository";
                ...
                <div className="bg-white shadow-default p-6">
                    <form className="flex flex-col gap-6" onSubmit={(e) => {
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-6">
                            <label className="font-medium text-gray-800 w-full max-w-xs">Expense Name</label>
                            <input type="text" placeholder="Enter Expense Name" className="input w-full max-w-md" name="nama_pengeluaran"
                                onChange={handleChange} value={input.nama_pengeluaran} required />
                        </div>

                        <div className="flex flex-wrap items-center justify-center gap-6">
                            <label className="font-medium text-gray-800 w-full max-w-xs">Select Date</label>
                            <input type="date" className="input w-full max-w-md" name="tanggal_pengeluaran"
                                onChange={handleChange}
                                value={input.tanggal_pengeluaran} required />
                        </div>
                    ...
                    <dialog id="edit_modal" className="modal" hidden>
                        <div className="modal-box">
                            ...
                            <p className="py-4">Are you sure you want to edit this expense?</p>
