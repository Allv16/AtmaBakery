...
import { AttendanceReportTable, IncomeReportTable, SalesReportTable } from '../../../components/Table/Table';
...
const DashboardOwner: React.FC = () => {
    ...
    const { data, error, isLoading, isValidating } = getAllSalesReport(selectedYear);
