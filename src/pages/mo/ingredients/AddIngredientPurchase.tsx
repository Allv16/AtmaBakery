            ...
            <div className="bg-white shadow-default p-6">
                ...
                {data && (
                    <form className="flex flex-col gap-6" onSubmit={(e) => {
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-6">
                            ...
                            <input type="date" placeholder="Enter Partner Name" className="input w-full max-w-md" name="tanggal_pembelian"
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-6">
                            ...
                            <input type="number" placeholder="Enter Purchase Quantity" className="input w-full max-w-md" name="jumlah_pembelian"
                                min="0" onChange={handleChange} required />
                        </div>
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-6">
                            ...
                            >
                                ...
                                {data && data.length > 0 ? (
                                    data.map((ingredient) => (
                                        <option key={ingredient.id_bahan_baku} value={ingredient.id_bahan_baku}>
                        ...
                        <div className="flex justify-end gap-3 mt-10">
                            ...
                            <button className="btn btn-primary" type="submit">Add Ingredient Purchase</button>
                        </div>
                    </form>
                )}
                <dialog id="edit_modal" className="modal" hidden>
                    <div className="modal-box">
                        ...
                        <p className="py-4">Are you sure you want to add this ingredient purchase?</p>
